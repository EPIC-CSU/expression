...
*                                                                *
*******************************************************************/
#ifndef _ISEL_PARSE_H_
#define _ISEL_PARSE_H_
...
typedef vector<int> ArrayOfIntType;
...
typedef vector<ISelArg> ISelArgListType;
...
typedef vector<ISelOp*> ISelOpListType;

typedef vector<ISelOpListType*> ISelRuleType;

extern ISelRuleType genericRules;
extern ISelRuleType targetRules;

// generic opcode mapping to number of rules
typedef map<int, ArrayOfIntType> OpcToRuleNoType;
