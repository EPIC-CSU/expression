...
void addStorageToCntrl(NodePtr storageRootNode)
{
	...
	// we also create mem.config here
...
fprintf(fp,"{\n");
fprintf(fp,"\n");
fprintf(fp,"  int memory_module = 0;\n");
...
fprintf(fp,"  }\n");
fprintf(fp,"\n");
fprintf(fp,"  if (!memory_module) {\n");
fprintf(fp,"	  cout << \" Address location out of range (not found in address map) \" << endl;\n");
fprintf(fp,"  }	  \n");
